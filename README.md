...
| ---------------------------- | ----------------- | ----------------- | ------------------------- |
| **[Key-J](https://github.com/jec1100/key-j)**| A web project that helps you compare the key in which two songs are performed. A tool for DJs or enthusiasts to compare track compatibility  | JavaScript, React, Node.js, Express, Jest, Puppeteer, Heroku| Teams work because their members are passionate about a shared, established goal. Something I will carry forward into every team and project I work on |
| **[Acebook](https://github.com/JEC1100/acebook-danger-noodles)**| A project to develop a Facebook-like social media platform. A platform for indivduals to connect to each others' profile | Ruby-On-Rails, JavaScript, HTML, CSS, Bootstrap, Devise, Active Storage, PostgreSQL, Capybara, RSpec, Heroku | The bigger the team, the more imperative it is that everyone knows what they are doing. Never get lost in the cracks on big groups. Speak up, pair up and take on significant responsibility |
...
| **[Notes App](https://github.com/JEC1100/js-notes-app)**| A project to let you create and view notes. For minimalist notekeepers | JavaScript, HTML, CSS | There are many ways to skin a cat. Respect the cat and get it right at the outset with sufficient time devoted to planning |
