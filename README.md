...
| **[Notes App](https://github.com/JEC1100/js-notes-app)**| A 4 person project to let you create and view notes. For minimalist notekeepers | 1 week | JavaScript, HTML, CSS | There are many ways to skin a cat. Respect the cat and get it right at the outset with sufficient time devoted to planning |
...
| **[RPSChallenge](https://github.com/JEC1100/rock_paper_scissors)**| A web app that lets you sign in and play Rock Paper Scissors with a virtual opponent. For anyone with a minute to spare wanting to play a quick game | 2 days | Ruby, RSpec, Rubocop | Setting up one's environment is like turning up early for work or an interview. Setting aside twice as much time as you think you need to install gems/set up a working test suite/file structure, is crucial |
## Skills
